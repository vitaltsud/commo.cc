...
export default async function HomeWithCityPage({ params }: PageProps) {
  ...
  try {
    ...
    const allProjCond = and(eq(projects.countryCode, country), eq(projects.citySlug, citySlug));
