...
| Домен        | Назначение        |
|-------------|-------------------|
| `commo.cc`  | Основной маркетплейс → https://commo.cc (приложение на порту 3000) |
| `www.commo.cc` | Редирект на https://commo.cc |
| `adm.commo.cc` | Админ-панель → https://adm.commo.cc (приложение на порту 3001). Не n8n; n8n только на ai.crmca.cc. |
